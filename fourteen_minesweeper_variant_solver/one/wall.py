...
model = CpModel()
mines = [[model.NewBoolVar(f"mine_{r}_{c}") for c in range(10)] for r in range(10)]
grid_array = [[[1, 1, 2] for _ in range(10)] for _ in range(10)]
rows = 10
cols = 10
rule_grid = [["W" for _ in range(10)] for _ in range(10)]
